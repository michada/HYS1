		...
		<div class="container">
			<div class="navigation">
				<div class="btn-group">
					...
					<button type="button" id="dropdown-toggle-categories"
				...
				<div class="btn-group filters">
					...
					<button type="button" id="dropdown-toggle-filters"
						class="btn btn-primary dropdown-toggle" data-toggle="dropdown"
						aria-expanded="false">
						<span class="caret"></span> <span class="sr-only">Toggle
							Dropdown</span>
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="#"><input id="showEvents.programmed"
								...
								ng-click="getEventData(idCategorySelected, categorySelected, DEFAULT_PAGE)">
								Programmed events</a></li>
			...
			<div class="page-header">
				...
				<div ng-show="text">
					<h3>Search by: {{ text | limitTo: 30 }}{{text.length > 30 ?
						'...' : ''}}</h3>
				</div>
			</div>
			<div class="content-section-a">
			...
			<div ng-show="!loading">
				<div id="products" class="row list-group">
					<div class="event-item item  col-xs-4 col-lg-4"
						ng-repeat="e in events" on-finish-render="ngRepeatFinished">
						<div class="thumbnail">
				...
				<div ng-show="events.length > 0">
					<nav>
						<ul class="pagination">
							...
							<li ng-repeat="n in range" id="page{{n}}"
								ng-class="{active: pagination.numPag + 1 == n}"
								ng-click="paging(n)"><a href="#">{{n}}</a></li>
				...
				<div ng-if="events.length == 0">
					<div class="event-not-found item  col-xs-4 col-lg-4">
						<div class="thumbnail">
							<h5>&nbsp;&nbsp;&nbsp;Oh! Unfortunately, no results were
								found.</h5>
						</div>
					</div>
